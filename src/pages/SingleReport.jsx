                ...
                <div className="reportWrap">
                    <div className="reportWrapLeft">
                        ...
                        <div className="reportInfo">
                            ...
                            <div className="infoItem">
                                <span>Category <span className='infoDy'>{storeRep.reportCategory}</span></span>
                            </div>
                            <div className="infoItem">
                                <span>Published on <span className='infoDy'>{storeRep.publishedOn}</span></span>
                            </div>
                            <div className="infoItem">
                                <span>Pages <span className='infoDy'>{storeRep.reportPages}</span></span>
                            </div>
                            <div className="infoItem">
                                <span>Format
                        ...
                        <div className="filterWrap">
                            <Link className="active" to={`/${repPar}/${repId}/overview`}>Overview</Link>
                        ...
                        <div className="reportOverview">
                            ...
                            <div className='repDescWrap' dangerouslySetInnerHTML={{ __html: (storeRep && storeRep.reportDescription) ? storeRep.reportDescription.replace(/\n/g, '<br />') : '' }} />
                        </div>
                        <hr></hr> 
                        {/* <AdSenseComponent/> */}
                    </div>
